  ...
  <div v-if="data" class="app">
    <div class="main-container">
      <div class="card">
        ...
        <div class="qr-code">
          <a href="http://qrcoder.ru" target="_blank">
            <img src="http://qrcoder.ru/code/?https%3A%2F%2Farthur-izmailyan.duckdns.org%2Flyceum-6%2Fmain&4&0" alt="main qr" title="QR код">
          </a>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="qr-code">
          <a href="http://qrcoder.ru" target="_blank">
            <a href="http://qrcoder.ru" target="_blank"><img src="http://qrcoder.ru/code/?https%3A%2F%2Farthur-izmailyan.duckdns.org%2Flyceum-6%2Fstudent-rules&4&0" width="164" height="164" border="0" title="QR код"></a>
          </a>
        </div>
      </div>
      ...
      <div class="card">
        ...
        <div class="qr-code">
          <a href="http://qrcoder.ru" target="_blank">
            <a href="http://qrcoder.ru" target="_blank"><img src="http://qrcoder.ru/code/?https%3A%2F%2Farthur-izmailyan.duckdns.org%2Flyceum-6%2Flyceum-regulation&4&0" width="180" height="180" border="0" title="QR код"></a>
          </a>
        </div>
      </div>
    </div>
